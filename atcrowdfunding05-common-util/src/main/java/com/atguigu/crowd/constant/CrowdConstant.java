...
public class CrowdConstant {
    ...
    public static final String MESSAGE_LOGIN_ACCT_UPDATE = "抱歉！目标账号已经被使用，不能修改；请再换个账号！";
    public static final String MESSAGE_LOGIN_ACCT_NO_EXIST = "抱歉，待删除的账号不存在，请检查后重试！";
    public static final String MESSAGE_CURR_LOGIN_ACCT_NO_DEL = "抱歉！当前用户不能被删除，请重试！";
    ...
    public static final String MESSAGE_ACCESS_DENIED = "抱歉，由于您没有权限，不能访问这个资源!";
    ...
    public static final String ATTR_NAME_ORDER_PROJECT_DATA = "orderProjectVO";
    public static final String ATTR_NAME_ADDRESS_DATA = "addressVOList";

    public static final String REDIS_CODE_PREFIX = "REDIS_CODE_PREFIX_";
    public static final String REDIRECT_ZUUL = "redirect:http://localhost";
