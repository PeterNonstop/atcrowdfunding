...
<script type="text/javascript">
    $(function (){
        ...
        // :eq(1)表示选择页面上的第二个元素
        // ">"表示选择子元素
        // :selected表示选择“被选中的”元素

        // select:eq(0) 页面内第一个select元素
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <ol class="breadcrumb">
                ...
                <li><a href="admin/get/page.html">用户数据列表</a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action="assign/do/role/assign.html" method="post" role="form" class="form-inline">
                        ...
                        <button id="submitBtn" type="submit" style="width: 100px;margin-top:10px;margin-left:115px;" class="btn btn-lg btn-success btn-block">保存</button>
                    </form>
                </div>
            </div>
        </div>
